...
Bump `@version` (userscript header) and `ourTwitchAdSolutionsVersion` together for functional changes. Current: vaft 53.0.0/40, video-swap-new 1.66/34, strip 1.9/26.
